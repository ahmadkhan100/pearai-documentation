...
If you want to see exactly what files CommitAI has indexed, the metadata is stored in `~/.pearai/index/index.sqlite`. You can use a tool like [DB Browser for SQLite](https://sqlitebrowser.org/) to view the `tag_catalog` table within this file.
